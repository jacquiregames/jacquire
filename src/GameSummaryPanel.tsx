          ...
          <tr>
            ...
            {HOTEL_CHAINS.map(chain => (
              <th key={chain} className={`hotel-header-${chain.toLowerCase()}`}>
                <img src={`/images/hotel/${chain.toLowerCase()}.png`} alt={chain} className="hotel-icon-header" />
              </th>
            ))}
            <th>Total</th>
          </tr>
  ...
  const highlights = useMemo(() => {
    ...
    return [
      bonusKing && {
        key: 'bonus-king',
        title: "Bonus King",
        image: "/images/gameover/bonus.png",
        player: bonusKing,
      ...
      hotelTycoon && {
        key: 'hotel-tycoon',
        title: "Hotel Tycoon",
        image: "/images/gameover/hotel.png",
        player: hotelTycoon,
      ...
      slowPoke && {
        key: 'slowpoke',
        title: "Slowpoke",
        image: "/images/gameover/slowpoke.png",
        player: slowPoke,
    ...
    <div className="game-summary-panel-container">
      ...
      <AnimatePresence>
        {animationPhase === 'done' && winners.length > 0 && (
          ...
          >
            <img src="/images/gameover/podium.png" alt="Winner's Podium" className="winner-podium-image" />
            <div className="winner-pill-overlay">
              {winners.map(winner => (
                <div key={winner.name} className="winner-display">
                  <img src="/images/gameover/crown.png" alt="Winner" className="winner-crown" />
