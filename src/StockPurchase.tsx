  ...
  return (
    <div className="stock-panel">
      <div className="panel-banner-container panel-banner-container--stock-purchase">
        <img src="/images/banner/buy.png" alt="Buy Stocks" className="panel-title-image panel-title-image--stock-purchase" />
          ...
          return (
            <div className="sp-chain-card" key={chain}>
              <div className={`sp-row-1 bg-${chain.toLowerCase()}`}>
                <img 
                  src={`/images/hotel/${chain.toLowerCase()}.png`} 
                  alt={chain} 
