// src/modal/TradeStockPowerModal.tsx
    ...
    >
      <div className="stock-panel trade-power-panel">
        <div className="panel-banner-container panel-banner-container--trade-power">
          <img src="/images/banner/trade.webp" alt="Trade Stocks" className="panel-title-image" style={{ height: 'auto' }} />
            ...
            {HOTEL_CHAINS.map(chain => {
              ...
              return (
                <div 
                  ...
                  onKeyDown={(e) => {
                    if ((e.key === "Enter" || e.key === " ") && isTradable) {
                      e.preventDefault();
                ...
                >
                  ...
                  <div className="tc-col-icon">
                    <img src={`/images/hotel/${chain.toLowerCase()}.webp`} alt={chain} />
                  </div>
                  {/* Col 2: Name */}
