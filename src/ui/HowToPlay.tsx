...
const HowToPlay: FC<HowToPlayProps> = ({ show, onClose, isIntro }) => {
  const [showVideo, setShowVideo] = useState(false);

  // Reset to text instructions whenever the modal is closed
  useEffect(() => {
    if (!show) {
      setShowVideo(false);
    }
      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div className="modal-header-left">
            {isIntro && (
              <button 
                className="button-primary how-to-play-video-btn" 
                onClick={() => setShowVideo(!showVideo)}
              >
                {showVideo ? "Read Instructions" : "How To Play Video"}
              </button>
            )}
          </div>
        ...
        <div className={`modal-body ${showVideo ? 'video-mode' : ''}`}>
          {showVideo ? (
            <div className="how-to-play-video-container">
              <video
                src="/videos/howtoplay.mp4"
                className="how-to-play-inline-video"
                controls
                autoPlay
            ...
            <article className="how-to-play-content">
              <div className="how-to-play-columns">
                ...
                <div className="how-to-play-column">
                  ...
                  <section className="how-to-play-section">
                    <h2 className="how-to-play-subheading">🏗️ Founding a Chain <img src="/images/cards/founded.webp" alt="" className="founded"/> </h2> 
                    <ul>
                    ...
                    <div className="how-to-play-stocks-header"> 
                      ...
                      <div className="how-to-play-stocks-cards">
                        {["luxor", "tower", "american", "festival", "worldwide", "continental", "imperial"].map((chain) => (
                          <img 
                            key={chain}
                            src={`/images/cards/card_${chain}.webp`} 
                            alt={chain} 
                            title={chain}
                ...
                <div className="how-to-play-column">
                  ...
                  <section className="how-to-play-section">
                    ...
                    <img src="/images/cards/list.webp" alt="Reference list of all hotel chains" className="hotel-list" />
                  </section>
                </div>
              </div>
            </article>
