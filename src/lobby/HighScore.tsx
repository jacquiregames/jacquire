...
// FIX (react-doctor: prefer-module-scope-pure-function): pure, no closure
// over component state/props — was being redefined on every render for no
// reason.
          ...
          <div>
            {displayScores.length > 0 ? (
              displayScores.map((entry, idx) => (
                <div 
                  className="score-row" 
                  key={`${currentPlayerCount}-${entry.name}-${entry.score}`}
